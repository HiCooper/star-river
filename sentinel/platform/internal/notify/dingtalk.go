...
[查看详情](http://localhost:3000/issues/%s)`, title, service, severity, aiCategory, aiSeverity, time.Now().Format("15:04:05"), issueID)
...
[查看详情](http://localhost:3000/issues/%s)`, service, title, time.Now().Format("15:04:05"), issueID)
